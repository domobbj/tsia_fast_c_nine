...
public class RingProgressBar extends View {
    ...
    public RingProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        textColor = mTypedArray.getColor(R.styleable.RingProgressBar_textColor, Color.RED);
        textSize = mTypedArray.getDimension(R.styleable.RingProgressBar_textSize, 35);
