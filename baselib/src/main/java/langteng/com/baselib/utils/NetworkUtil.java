...
public class NetworkUtil {
    ...
    public static int getNetType(Context context) {
        ...
        if (manager.getActiveNetworkInfo() != null && manager != null) {
    ...
    public static int getNetType1(Context context) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (type.equalsIgnoreCase("WIFI")) {
                ...
                mNetWorkType = getMobileType1(context);
            }
        } else {
            mNetWorkType = 4;
        }
    ...
    public static int getMobileType1(Context context) {
