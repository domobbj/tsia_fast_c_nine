package langteng.com.baselib.utils.anti.emulator;
...
import langteng.com.baselib.utils.anti.common.Property;
import langteng.com.baselib.utils.anti.common.Utilities;
import langteng.com.baselib.utils.anti.debugger.FindDebugger;
...
//        System.loadLibrary("anti");
    ...
    public static boolean hasPipes() {
        for (String pipe : known_pipes) {
            ...
            if (qemu_socket.exists()) {
                //          Logger.i("---hasPipes--","" + true);
                return true;
            }
        }
        //      Logger.i("---hasPipes--","" + false);
        return false;
    }
    ...
    public static boolean hasGenyFiles() {
        for (String file : known_geny_files) {
            ...
            if (geny_file.exists()) {
                //           Logger.i("----hasGenyFiles--","" + true);
                return true;
            }
        }
        //      Logger.i("----hasGenyFiles--","" + false);
        return false;
    }
            ...
            if (drivers_file.exists() && drivers_file.canRead()) {
                ...
                for (String known_qemu_driver : FindEmulator.known_qemu_drivers) {
                    if (driver_data.indexOf(known_qemu_driver) != -1) {
                        //                  Logger.i("----hasQEmuDrivers--","" + true);
                        return true;
                    }
                }
            }
        }
        //       Logger.i("----hasQEmuDrivers--","" + false);
        return false;
    }
...
//        Logger.i("---hasEmulatorBuild: ", "BOARD:" + BOARD + "  BRAND:" + BRAND + "  DEVICE:" + DEVICE
//                + "  HARDWARE:" + HARDWARE + "  MODEL:" + MODEL + "  PRODUCT:" + PRODUCT);
    ...
    //判断是否存在基带信息
    public static boolean hasBaseband() {
        try {
            Class localClass = Class.forName("android.os.SystemProperties");
            Object localObject = localClass.newInstance();
            boolean bool = ((String) localClass.getMethod("get", new Class[]{String.class, String.class}).invoke(localObject, new Object[]{"gsm.version.baseband", "no message"})).equals("no message");
//            Logger.i("----hasBaseband--0-","" + bool);
            return bool;
        } catch (Exception localException) {
        }
//        Logger.i("----hasBaseband--1-","" + false);
        return false;
    }

    public static boolean hasEmulatorAdb() {
        try {
//            Logger.i("----hasEmulatorAdb--","" + FindDebugger.hasAdbInEmulator());
            return FindDebugger.hasAdbInEmulator();
        } catch (Exception exception) {
            exception.printStackTrace();
//             Logger.i("----hasEmulatorAdb--","" + false);
