...
import langteng.com.redpocketmoney.db.Config;
...
public class NewFriendConversation extends Conversation{
    ...
    public int getUnReadCount() {
        return NewFriendManager.getInstance(ProgrammingApplication.get()).getNewInvitationCount();
    }

    @Override
    public void readAllMessages() {
        //批量更新未读未认证的消息为已读状态
        NewFriendManager.getInstance(ProgrammingApplication.get()).updateBatchStatus();
    }
