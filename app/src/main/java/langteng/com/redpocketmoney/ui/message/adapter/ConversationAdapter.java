...
import langteng.com.redpocketmoney.ui.message.adapter.bean.Conversation;
import langteng.com.redpocketmoney.util.TimeUtil;
...
public class ConversationAdapter extends BaseRecyclerAdapter<Conversation> {
    ...
    public void bindView(BaseRecyclerHolder holder, Conversation conversation, int position) {
        ...
        holder.setText(R.id.tv_recent_time,
                TimeUtil.getChatTime(false, conversation.getLastMessageTime()));
        //会话图标
