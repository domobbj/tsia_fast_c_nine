package langteng.com.redpocketmoney.ui.base;
...
import langteng.com.redpocketmoney.util.DisplayConfig;
    ...
    private void display(ImageView iv, String url, boolean isCircle, int defaultRes, ImageLoadingListener listener){
        if(!url.equals(iv.getTag())){//增加tag标记，减少UIL的display次数
            ...
            ImageLoader.getInstance().displayImage(url, imageAware,
                    DisplayConfig.getDefaultOptions(isCircle,defaultRes),listener);
        }
    }
